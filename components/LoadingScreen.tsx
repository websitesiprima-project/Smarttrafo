  ...
  return (
    <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#0f172a] text-white">
      ...
      <div className="relative mb-6">
        <div className="absolute inset-0 bg-[#146C94] blur-xl opacity-20 rounded-full animate-pulse"></div>
        <div className="w-20 h-20 bg-linear-to-br from-[#146C94] to-[#0f172a] rounded-2xl flex items-center justify-center border border-[#146C94]/30 shadow-2xl relative z-10 animate-bounce">
